...
class PlaylistApplicationService:
    ...
    async def registerPlaylist(self, arg_keyword: str, arg_url: str):
        ...
        playlist = Playlist(
            ...
            fileName=PlaylistFileName(keyword.keyword),
            keyword=PlaylistKeyword(keyword.keyword),
            title=PlaylistTitle(playlistJson["playlistTitle"]),
            author=PlaylistAuthor(playlistJson["playlistAuthor"]),
            description=PlaylistDescription(playlistJson["playlistDescription"]),
